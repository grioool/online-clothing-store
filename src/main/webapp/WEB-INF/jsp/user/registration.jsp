...
<div class="container-fluid d-flex justify-content-center mt-4">
    <form name="registration" action="<c:url value="/controller"/>" method="post" class="needs-validation w-30 " novalidate>
        ...
        <div class="form-group mt-3">
            ...
            <div class="mt-2">
                <div class="mt-2 d-flex justify-content-center">
                    <a href="<c:url value="/controller?command=to_login"/>"><fmt:message key="link.login"/></a>
                </div>
            </div>
        </div>
    </form>

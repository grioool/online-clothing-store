...
<div class="container-fluid d-flex justify-content-center mt-4">
    <div class="container-fluid w-50">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="btn-group" role="group">
                                        <form name="deleteFromCart-${item.getKey().id}" method="post"
                                              action="<c:url value="/controller"/>" class="needs-validation w-100" novalidate>
        ...
        <c:if test="${requestScope.cart.size() > 0}">
            <a class="btn btn-dark mb-3" type="button" href="<c:url value="/controller?command=to_create_order"/>"

...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <div class="container-fluid ">
        ...
        <a class="navbar-brand" href="<c:url value="/controller?command=to_main"/>">
            <img src="<c:url value='/img/logo.png'/>" alt="GRIOOOL" width="200" height="40"/>
        </a>
        ...
        <div class="collapse navbar-collapse mr-5 row" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 col-9">
                ...
                <li class="nav-item">
                    <a class="nav-link active " aria-current="page"
                       href="<c:url value="/controller?command=to_main"/>"><fmt:message key="link.home"/></a>
                </li>
                ...
                <c:if test="${isAuthorized}">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<c:url value="/controller?command=to_profile"/>">
                    ...
                    <c:if test="${isAdmin}">
                        <li class="nav-item">
                            ...
                            value="/controller?command=to_users&page=1"/>">
                                <fmt:message key="link.users"/></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<c:url value="/controller?command=to_orders&page=1"/>">
            ...
            <div class="navbar-nav col-3 d-flex align-content-center justify-content-end">
                ...
                <c:if test="${isAuthorized}">
                    <a href="<c:url value="/controller?command=to_cart"/>">
                        <img id="cart" src="<c:url value='/img/clear_cart.png'/>" alt="cart" width="35" height="35"/>
                    </a>
                </c:if>

                <form class="mb-0" style="margin-left: 20px" action="<c:url value="/controller"/>" method="post">
                ...
                <c:if test="${not isAuthorized}">
                    <form class="mb-0" style="margin-left: 20px" action="<c:url value='/controller'/>">

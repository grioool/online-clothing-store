...
public class OrderDao extends AbstractDao<Order> {
    ...
    protected Optional<Order> parseResultSet(ResultSet resultSet) throws SQLException, DaoException {
        Order order = Order.builder()
                ...
                .withPaymentMethod(PaymentMethod.valueOf(resultSet.getString(OrderField.PAYMENT_METHOD.getField())))
                .withOrderStatus(OrderStatus.valueOf(resultSet.getString(OrderField.STATUS.getField())))
                ...
                .withDeliveryCountry(Country.valueOf(resultSet.getString(OrderField.COUNTRY.getField())))
                .withUser(UserDao.INSTANCE.findUserById(resultSet.getInt(OrderField.USER.getField())))
                .withDeliveryTown(Town.valueOf(resultSet.getString(OrderField.TOWN.getField())))
                .build();

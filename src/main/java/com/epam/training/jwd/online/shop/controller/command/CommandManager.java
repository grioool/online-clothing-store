...
public enum CommandManager {
    ...
    TO_ADD_PRODUCT_CATEGORY(new ToAddCategoryCommand(), "to_add_product_category"),
    ...
    ADD_PRODUCT_CATEGORY(new AddProductCategoryCommand(), "add_product_category"),
    ADD_PRODUCT(new AddProductCommand(), "add_product"),
    DELETE_PRODUCT_CATEGORY(new DeleteProductCategoryCommand(), "delete_product_category"),
    EDIT_PRODUCT_CATEGORY(new EditProductCategoryCommand(), "edit_product_category"),
